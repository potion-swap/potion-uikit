...
var Icon$x = function (props) {
    return React__default['default'].createElement("img", __assign({}, props, { width: "24px", height: "35px", src: "/images/price-token.png" }));
};
...
var Icon$N = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("path", { d: "M11.44 26.63h-.1a1 1 0 01-.9-1.09c.13-1.46.26-2.58.39-3.7s.25-2.22.39-3.66a1 1 0 01.38-.7 1 1 0 01.77-.2 5.81 5.81 0 001.56-.08c.4 0 .82-.09 1.26-.12l2-.09 1.71-.07a1 1 0 011.05.92c.1 1.26.2 2.41.3 3.54.12 1.35.24 2.68.35 4.18a1 1 0 01-2 .15c-.12-1.49-.23-2.82-.35-4.15-.07-.85-.15-1.69-.22-2.59h-.76l-1.95.09c-.39 0-.77.07-1.13.11s-.7.08-1 .1c-.11 1-.21 1.9-.31 2.77-.12 1.11-.25 2.22-.38 3.66a1 1 0 01-1.06.93z" }),
        React__default['default'].createElement("path", { d: "M14.83 5h.32c7.3.28 13 5.49 12.76 8.8-.2 2.39-3.45 2.84-7.68 3-1.59.07-3.32.1-5.08.18h-1.37a21 21 0 01-2.78-.06c-5.4-.64-6.74-3.07-6.74-3.07S7.74 5 14.83 5m0-2C6.47 3 2.56 12.7 2.4 13.11a2 2 0 00.11 1.71c.19.34 2 3.35 8.26 4.1a25.23 25.23 0 003 .17h1.46l2.7-.1 2.38-.08c3.44-.15 9.21-.4 9.59-4.86a7.45 7.45 0 00-2.2-5.35A17.92 17.92 0 0015.23 3z" }),
        React__default['default'].createElement("path", { d: "M14.56 6.86c-.83-.62-2.54.38-3.36 1-1.17.95-2.46 2.81-1.86 3.77s3.05.9 4.43-.34 1.7-3.75.79-4.43zM13.46 13c-.37-.28-1.14.17-1.51.47-.53.42-1.11 1.26-.84 1.69s1.37.41 2-.15.76-1.71.35-2.01zM16.55 11.06c-.29-.22-.89.13-1.18.36s-.85 1-.64 1.32 1.06.31 1.54-.12.6-1.33.28-1.56zM30 29a1 1 0 01-.92-.59 2.78 2.78 0 00-1.41-1.45A3.32 3.32 0 0024 28.53a1.08 1.08 0 01-.88.44 1 1 0 01-.83-.52 3.5 3.5 0 00-1.58-1.54 1.6 1.6 0 00-.37-.15 4 4 0 00-4.25 1.78 1 1 0 01-1.75-.18 2.71 2.71 0 00-1.39-1.43 2.84 2.84 0 00-2.5.42 4.11 4.11 0 00-1.18 1.17 1 1 0 01-1.75-.13 2.68 2.68 0 00-1.42-1.46 3 3 0 00-3.32 1 1 1 0 01-1.53-1.31 5 5 0 015.58-1.6 4.47 4.47 0 011.72 1.23 4.89 4.89 0 01.81-.63 4.76 4.76 0 014.3-.6 4.21 4.21 0 011.73 1.23 5.7 5.7 0 015.51-1.46 3.65 3.65 0 01.69.27 5.09 5.09 0 011.64 1.24 5 5 0 015.16-1.28 4.79 4.79 0 012.53 2.48 1 1 0 01-.5 1.34A1 1 0 0130 29z" })));
};
...
var Icon$Y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement
 0 00-1.83 1.82c-.14.19-.27.37-.42.54a17.7 17.7 0 01-2.13 2.24.63.63 0 01-.88-.05.62.62 0 01.05-.88 17.46 17.46 0 002-2.08c.14-.17.27-.35.4-.52a7.28 7.28 0 012.22-2.16 7.56 7.56 0 011.51-.58 9.72 9.72 0 001.12-.41c.61-.29 1.18-.91 1-1.47s-.87-.9-1.58-1.15c-.45-.17-.88-.33-1.32-.46a2.28 2.28 0 11-4.56 0v-.1a17.66 17.66 0 00-2.7 1.3 20.93 20.93 0 01-2.74 1.3 20.24 20.24 0 01-5.48.93l-.71.06A13.75 13.75 0 005 11.65c-1.46.83-2.87 2.5-2.71 4.36A3.81 3.81 0 003 17.94a.63.63 0 01-.16.87.58.58 0 01-.36.11zM13.5 21.54a.62.62 0 01-.21-1.21c.16-.06.33-.14.5-.22l1.21-.58c.68-.31 1.32-.61 2-.93l.21-.1.18-.09a.62.62 0 01.84.25.63.63 0 01-.26.85l-.22.11-.18.09c-.67.33-1.35.65-2 .95l-1.22.57c-.2.09-.4.19-.61.27a.85.85 0 01-.24.04z" }),
        React__default['default'].createElement("path", { d: "M24.55 9.16a2.28 2.28 0 01-2.28-2.28 2.47 2.47 0 01.18-.88 1.69 1.69 0 01.17-.29 2.27 2.27 0 011.91-1 2.24 2.24 0 012 1.22 1.94 1.94 0 01.13.3 2.21 2.21 0 01.13.76 2.28 2.28 0 01-2.24 2.17zm0-3.32a1 1 0 00-.88.49.53.53 0 00-.08.14 1.07 1.07 0 00-.08.41 1 1 0 002.08 0 1 1 0 00-.13-.5 1 1 0 00-.91-.54zM9.85 17.82a.62.62 0 01-.44-.18.61.61 0 010-.88c1.1-1.1 3.76-2.16 5.35-2.8.43-.17.83-.33.94-.39.59-.32 6.26-2.22 8.08-2.05a5.61 5.61 0 001.43 0 .64.64 0 01.7.14.62.62 0 010 .88c-.19.18-.51.35-2.23.18-1.38-.12-6.75 1.57-7.36 1.91-.18.09-.49.22-1.08.45-1.4.56-4 1.6-4.93 2.52a.66.66 0 01-.46.22zM25 11.68zm0 0zm0 0z" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(IconContainer, null,
        React__default['default'].createElement("img", __assign({}, props, { src: "/images/potionswap_logo.png", alt: "", width: "480", height: "382" }))));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    VaultIcon: Icon$1c,
    StoreIcon: Icon$1d,
    AnalyticIcon: Icon$1e,
    DonateIcon: Icon$1f,
    BadgeNewIcon: Icon$1g,
    GaugeIcon: Icon$1h,
    inSpiritIcon: Icon$1i,
    NftZoo: Icon$1j,
    Rocket: Icon$1k,
    LendIcon: Icon$1l
});
...
var NewIcon = styled__default['default'](Icon$1g)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"], ["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"])), rotate$1);
